...
PYBIND11_MODULE(daedalus_cpp, m) {
    ...
    py::class_<Matrix<double>>(m, "Matrix", py::buffer_protocol())
        ...
        .def(py::init<const std::vector<std::vector<double>>&>()) // For 2D lists
        .def(py::init<size_t, size_t, const std::vector<double>&>()) // For 1D lists
        ...
        .def("set_row", &Matrix<double>::set_row, py::arg("idx"), py::arg("new_row"))
        ...
        .def("mean", &Matrix<double>::mean, py::arg("axis"))
        ...
        .def("max", &Matrix<double>::max, py::arg("axis"))
        .def("min", &Matrix<double>::min, py::arg("axis"))
        .def("max_global", &Matrix<double>::max_global)
        .def("min_global", &Matrix<double>::min_global)
